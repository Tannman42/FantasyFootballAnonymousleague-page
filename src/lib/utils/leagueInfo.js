/*   STEP 1   */
export const leagueID = 1217594769824296960; // your league ID
export const leagueName = "Fantasy Football Anonymous"; // your league name
...
export const homepageText = `
  <p>Welcome to the Fantasy Football Anonymous League Website. This is a 12 team .5 PPR superflex dynasty league. This is our first league year 2025 with your commisioners being Miles and Tanner. We look forward to updating this information as our league continues on! This league is mix of family and friends which make the matchups nice and juicy.</p>
...
// {
    //   "roster": 1,  // (DEPRECATED! Don't use this anymore) ID of the roster that the manager manages (look at the order of the power rankings graph)
      "managerID": "723748468010594304",  // the user's manager ID, go to https://api.sleeper.app/v1/league/<your_league_id>/users to find user IDs (you can use older leagueIDs to find user IDs for managers that are no longer in the league)
      "name": "Tanner",
    ...
    //   "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
      ...
      "favoriteTeam": "sea", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
       "mode": "Dyansty", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
    //   "rival": {
    ...
    //   "favoritePlayer": 1426, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
       ...
       "philosophy": "Every week is a champion ship week", // (optional)
