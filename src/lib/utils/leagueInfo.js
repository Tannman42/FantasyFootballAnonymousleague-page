...
export const leagueName = "Fantasy_Football_Anonymous"; // your league name
...
export const managers = [
    // {
    //   "roster": 1,  723748468010594304  // ID of the roster that the manager manages (look at the order of the power rankings graph)
    //   "name": "Tanner",
